...
const TermsAndCondScreen = ({navigation}) => {
    return(
        <ScrollView style={styles.container}>
            <Text style={{fontSize: 15, color: 'black'}}>AGREEMENT TO TERMS
{'\n'}
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and LaBmAcH ("Company", “we”, “us”, or “our”), concerning your access to  mobile application LaBmAcH. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THIS APP AND YOU MUST DISCONTINUE USE IMMEDIATELY.
{'\n'}
...
{'\n'}
Provided that you are eligible to use the app you are granted a limited license to access and use the Site and to download or print a copy of any portion of the Content to which you have properly gained access solely for your personal, non-commercial use. We reserve all rights not expressly granted to you in and to the app, the Content and the Marks.
{'\n'}
{'\n'}
...
GOVERNING LAW
{'\n'}
These Terms shall be governed by and defined following the laws of India. LaBmAcH and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these terms.
{'\n'}
{'\n'}
DISPUTE RESOLUTION
{'\n'}
You agree to irrevocably submit all disputes related to Terms or the relationship established by this Agreement to the jurisdiction of the India courts. LaBmAcH shall also maintain the right to bring proceedings as to the substance of the matter in the courts of the country where you reside or, if these Terms are entered into in the course of your trade or profession, the state of your principal place of business.
{'\n'}
{'\n'}
CORRECTIONS
{'\n'}
